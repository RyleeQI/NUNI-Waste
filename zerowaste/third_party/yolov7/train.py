...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', 
                        type=str, 
                        default='/zerowaste/third_party/yolov7/pretrained_models/yolov7.pt', 
                        help='initial weights path')
    parser.add_argument('--cfg', 
                        type=str, 
                        default='/zerowaste/third_party/yolov7/cfg/training/yolov7-zerowaste.yaml', 
                        help='model.yaml path')
    parser.add_argument('--data', 
                        type=str, 
                        default='/zerowaste/third_party/yolov7/data/zerowaste.yaml', 
                        help='data.yaml path')
    parser.add_argument('--hyp', 
                        type=str, 
                        default='/zerowaste/third_party/yolov7/data/hyp.zerowaste.yaml', 
