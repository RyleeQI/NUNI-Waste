...
parser.add_argument('--j', 
                    help='JSON file', 
                    default="/root/autodl-tmp/zerowaste_database_resized/{}/labels.json".format(_DATA_TYPE),
                    dest='json', 
                    required=False)

parser.add_argument('--o', 
                    default="/root/autodl-tmp/zerowaste_database_resized/{}/yolo_labels".format(_DATA_TYPE),
...
class DatabaseConverter:
    ...
    def _convert_anno(self, images_info):
        ...
        for anno in self.labels['annotations']:
            ...
            if image_info is None or len(image_info) < 1:
                continue
    ...
    def _save_txt(self, anno_dict):
        for k, v in anno_dict.items():
            ...
            print(file_name)
            save_file = os.path.join(output, file_name)
