...
from utils.datasets import LoadZeroWasteImagesAndLabels
...
class WandbLogger():
    ...
    def log_dataset_artifact(self, data_file, single_cls, project, overwrite_config=False):
        ...
        self.train_artifact = self.create_dataset_table(LoadZeroWasteImagesAndLabels(
            data['train']), names, name='train') if data.get('train') else None
        self.val_artifact = self.create_dataset_table(LoadZeroWasteImagesAndLabels(
