...
class Exp(BaseExp):
    def __init__(self):
        ...
        self.data_dir = "/root/autodl-tmp/zerowaste_database"
        # name of annotation file for training
        self.train_ann = "train/labels.json"
        # name of annotation file for evaluation
        self.val_ann = "val/labels.json"
        # name of annotation file for testing
        self.test_ann = "test/labels.json"
    ...
    def get_dataset(self, cache: bool = False, cache_type: str = "ram"):
        ...
        """
        from yolox.data import COCODataset, TrainTransform, ZerowasteDataset
    ...
    def get_eval_dataset(self, **kwargs):
        from yolox.data import COCODataset, ValTransform, ZerowasteDataset
...
class ExpZeroWaste(BaseExp):
    ...
    def get_dataset(self, cache: bool = False, cache_type: str = "ram"):
        ...
        Args:
            ...
            cache_type (str, optional): Defaults to "ram".
                ...
                "disk": Caching imgs to disk for fast training.
        """
        from yolox.data import TrainTransform, ZerowasteDataset

        return ZerowasteDataset(
            data_dir=self.data_dir,
            json_file=self.train_ann,
            name="train",
            img_size=self.input_size,
    ...
    def get_eval_dataset(self, **kwargs):
        from yolox.data import ValTransform, ZerowasteDataset
        testdev = kwargs.get("testdev", False)
        legacy = kwargs.get("legacy", False)
