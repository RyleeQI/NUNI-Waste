...
""",
    ...
    parser.add_argument("--config-file",
                        default="/zerowaste/deeplab/configs/seg_zerowaste_base.yaml", 
                        metavar="FILE", help="path to config file")
    # parser.add_argument("--dataroot",
    #                     default="/root/autodl-tmp/zerowaste_database", 
    #                     metavar="FILE", help="path zerowaste_database")    
    parser.add_argument(
        "--resume",
        action="store_true",
...
if __name__ == "__main__":
    ...
    parser.add_argument("--dataroot", type=str, 
                        default="/zerowaste/zerowaste_database_resized/",
